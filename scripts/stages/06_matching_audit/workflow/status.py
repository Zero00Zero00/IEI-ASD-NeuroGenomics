...
print(f"MAR06_OUT={OUT}")
for f in ["MAR06_RAW26_AUTHORITY_BINDING.tsv","MAR06_preflight_report.tsv","MAR06_preanalysis_lock.json",
          "MAR06_STOPA_RELEASE.txt","MAR06_raw26_candidate_support.tsv","MAR06_raw26_set_integrity.tsv",
          "MAR06_raw26_balance.tsv","MAR06_common_matching_qc.tsv","MAR06_matching_gate.tsv",
          "MAR06_postflight_checks.tsv","MAR06_PASS.txt"]:
