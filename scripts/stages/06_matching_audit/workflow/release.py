...
(OUT/"MAR06_STOPA_RELEASE.txt").write_text(
 "decision=PASS\ntrack=MOLECULAR_AUTISM_REVISION\nstage=MAR06\ngate=A\n"
 f"reviewer=MANUAL_EXPERT_REVIEW\ntimestamp_utc={utc()}\npreanalysis_lock_sha256={sha256_file(p)}\n"
 "notes=Audit existing frozen matched-null objects only; no matcher retuning or matched-set regeneration.\n",
 encoding="utf-8")
print("MAR06_GATE_A=PASS")
