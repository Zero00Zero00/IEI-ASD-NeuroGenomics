...
print(f"MAR08_OUT={OUT}")
for n in ["MAR08_preflight_report.tsv","MAR08_preanalysis_lock.json","MA_MAR08_STOPA_RELEASE.txt","analysis/MAR08_CHAIN_FAILURE_LOCALIZATION.tsv","analysis/MAR08_LEAVE_ONE_DRIVER.tsv","analysis/MAR08_LEAVE_TWO_DRIVER.tsv.gz","MAR08_INFLUENCE_SUMMARY.tsv","MAR08_MANUSCRIPT_DECISION.tsv","MAR08_postflight_checks.tsv","MAR08_PASS.txt"]:
 p=OUT/n; print(("OK  " if p.is_file() else "MISS"),p)
